...
export const DEFAULT_SETTINGS: AppSettings = {
  ...
  normal_conversation_backend: "anthropic",
  nsfw_conversation_backend: "anthropic",
  normal_conversation_provider: "anthropic",
  normal_conversation_model: "claude-sonnet-4-5",
  nsfw_conversation_provider: "anthropic",
  nsfw_conversation_model: "claude-sonnet-4-5",
  cheap_conversation_provider: "anthropic",
  cheap_conversation_model: "claude-sonnet-4-5",
  smart_conversation_provider: "anthropic",
  smart_conversation_model: "claude-opus-4-5",
  standard_image_backend: "openai",
  nsfw_image_backend: "mock-private-nsfw-image",
  standard_image_provider: "openai",
  standard_image_model: "gpt-image-1",
  ...
  smart_reply_provider: "anthropic",
  smart_reply_model: "claude-sonnet-4-5",
  summary_provider: "anthropic",
  summary_model: "claude-sonnet-4-5",
  image_prompt_provider: "anthropic",
  image_prompt_model: "claude-sonnet-4-5",
...
export const MODEL_PRESETS: Record<ModelPresetKey, { label: string; description: string; config: ModelPresetConfig }> = {
  balanced: {
    label: "バランス",
    description: "Claude Sonnet を中心に、会話の安定性とコストをバランスよく配分。",
    config: {
      normal_conversation_provider: "anthropic",
      normal_conversation_model: "claude-sonnet-4-5",
      smart_conversation_provider: "anthropic",
  ...
  budget: {
    label: "バジェット",
    description: "Claude Sonnet に統一し、モデル切替のぶれを抑える。",
    config: {
      normal_conversation_provider: "anthropic",
      normal_conversation_model: "claude-sonnet-4-5",
      smart_conversation_provider: "anthropic",
      smart_conversation_model: "claude-sonnet-4-5",
      director_provider: "anthropic",
      director_model: "claude-sonnet-4-5",
      smart_reply_provider: "anthropic",
      smart_reply_model: "claude-sonnet-4-5",
